...
export const initializePayment = async ({ amount, currency = 'ETB', email, firstName = 'Client', lastName = 'Partner', txRef, title = 'Alpha Cut Editing Payment', description = 'Video Editing Proposal Payment', returnUrl, callbackUrl, }) => {
