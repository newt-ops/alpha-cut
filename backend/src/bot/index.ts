...
export const sendTelegramNotification = (chatId: string, text: string) => rawSendTelegramNotification(bot, chatId, text);
export const sendRevisionNotificationTelegram = (project: any) => rawSendRevisionNotificationTelegram(bot, project);
export const sendProposalNotificationTelegram = (project: any, clientChatId: string) => rawSendProposalNotificationTelegram(bot, project, clientChatId);
export const sendDeliveryNotificationTelegram = (project: any, clientChatId: string) => rawSendDeliveryNotificationTelegram(bot, project, clientChatId);
export const sendPaymentReceiptNotificationTelegram = (data: any) => rawSendPaymentReceiptNotificationTelegram(bot, data);
export const updateTelegramStatusCard = (project: any, clientChatId: string) => rawUpdateTelegramStatusCard(bot, project, clientChatId);
export const updateContractTelegramStatusCard = (contract: any, clientChatId: string, count: number) => rawUpdateContractTelegramStatusCard(bot, contract, clientChatId, count);
