...
export interface ToastContextType {
  toast: (params: { message: string; type?: 'success' | 'error' | 'info'; duration?: number }) => void;
...
export const ToastProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const addToast = useCallback(
    ({ message, type = 'info', duration = 4000 }: { message: string; type?: 'success' | 'error' | 'info'; duration?: number }) => {
